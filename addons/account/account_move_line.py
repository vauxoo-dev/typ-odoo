...
class account_move_line(osv.osv):
    ...
    def _update_check(self, cr, uid, ids, context=None):
        ...
        for line in self.browse(cr, uid, ids, context=context):
            ...
            if line.reconcile_id:
                print "account_move_line object"
                print "===================="
                print "line.move_id.name: ", line.move_id.name
                print "line.reconcile_id.id: ", line.reconcile_id.id
                print "line.reconcile_id.name: ", line.reconcile_id.id
                print "line.reconcile_id.opening_reconciliation: ", line.reconcile_id.opening_reconciliation
