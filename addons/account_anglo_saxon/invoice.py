        ...
        if inv.type in ('out_invoice','out_refund'):
            for i_line in inv.invoice_line:
                if i_line.product_id and i_line.product_id.valuation == 'real_time':
                    #print "========== account_anglo_saxon ========="
                    #print "product_id.name: ", i_line.product_id.name
                    #print "product_id.standard_price: ", i_line.product_id.standard_price
                    #print "quantity: ", i_line.quantity
                    #print "=================================================================="
                    #HT#if inv.type == 'out_invoice':
                    ...
                    #HT#else:
                        ...
                        # first check the product, if empty check the category
                    #HT#    dacc = i_line.product_id.property_stock_account_input and i_line.product_id.property_stock_account_input.id
                    #HT#    if not dacc:
                    #HT#        dacc = i_line.product_id.categ_id.property_stock_account_input_categ and i_line.product_id.categ_id.property_stock_account_input_categ.id
