...
class stock_partial_picking(osv.osv_memory):
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        res = super(stock_partial_picking, self).default_get(cr, SUPERUSER_ID, fields, context=context)
        ...
        if 'move_ids' in fields:
            ...
            moves = [self._partial_move_for(cr, SUPERUSER_ID, m) for m in picking.move_lines if m.state not in ('done','cancel')]
